"""ERM Final Project Launch

   ros2 launch erm-project main.launch.py

This should start
  1) RVIZ, ready to view the robot
  2) The robot_state_publisher to broadcast the robot model
  3) The main code to move the joints
...
def generate_launch_description():
    ...
    rvizcfg = os.path.join(pkgdir('me133a-final-project'), 'rviz/viewurdfplus.rviz')

    # Locate the URDF file.
    urdf = os.path.join(pkgdir('me133a-final-project'), 'urdf/iiwa7.urdf')
